  ...
  return (
    <>
      <div className="row-header">
        ...
        <h3 className="category-name">Kết quả tìm kiếm "{searchParams.get('q')}"</h3>
      </div>
      <div className="row-tabs">
        <ul className="nav nav-pills v-tabs" role="tablist">
          <li className="nav-item" role="presentation">
            <button className="nav-link active">Phim</button>
          </li>
          <li className="nav-item" role="presentation">
            <button className="nav-link">Diễn viên</button>
          </li>
        </ul>
      </div>
    </>
